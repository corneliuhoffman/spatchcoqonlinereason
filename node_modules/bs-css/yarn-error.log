Arguments: 
  /usr/local/bin/node /usr/local/bin/yarn run build
...
Lockfile: 
  ...
  bs-jest@^0.1.0:
    version "0.1.0"
    resolved "https://registry.yarnpkg.com/bs-jest/-/bs-jest-0.1.0.tgz#33c3a81d4980ec8dde97b5c8398c5388df26b859"
    dependencies:
      jest "^19.0.2"
  ...
  istanbul-lib-instrument@^1.1.1, istanbul-lib-instrument@^1.7.5, istanbul-lib-instrument@^1.9.2:
    version "1.9.2"
...
Trace: 
  ...
  Exit code: 2
  Command: sh
  Arguments: -c bsb -make-world
  Directory: /Users/andreas/code/bs-css
  Output:
